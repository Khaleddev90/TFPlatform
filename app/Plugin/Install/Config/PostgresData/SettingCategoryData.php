...
class SettingCategoryData {
	...
	public $records = array(
		...
		array(
			...
			'description' => 'Google PageSpeed is also easy to setup through DNS change. This will optimize site\'s HTML, JavaScript, Style Sheets and images on the fly. You may not usually need to turn this on as Nicolas TJPlatform script is highly optimized already.',
			'plugin_name' => 'HighPerformance'
		),
		array(
			'id' => '28',
		...
		array(
			...
			'description' => 'By enabling this, most of the pages will be disk-cached. This will avoid PHP and database access. Caveat of this approach is that users will be presented with little outdated contents. Since, this Nicolas TJPlatform script is highly optimized for this approach, this is highly recommended for good performance. ',
			'plugin_name' => 'HighPerformance'
		),
		array(
			'id' => '33',
