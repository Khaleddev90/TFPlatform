...
/**
 *
 * @package		TJPlatformUltraPlus
 * @author 		amal_196at13
 * @copyright 	Copyright (c) 2012 {@link http://www.Nicolas.com/ Nicolas Infoway}
 * @license		http://www.Nicolas.com/ Nicolas Infoway Licence
 * @since 		2012-03-07
 **/
if (!defined('ROOT')) {
...
<head>
<title>TJPlatformUltraPlus - Diagnostic Tool</title>
<style type="text/css">
body{
	color:#4c4c4c;
	line-height:18px;
...
<h1>TJPlatformUltraPlus Diagnostic Tool</h1>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#setting_up_files" target="_blank">http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#setting_up_files</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#setting_up_database" target="_blank">http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#setting_up_database</a>
	</span>
</p>
...
<p class="info-details">
	<span> Note: </span>
    <span>
		<br/>For more info: <a href="http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#manage_settings" target="_blank">http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#manage_settings</a>
	</span>
</p>
<?php
