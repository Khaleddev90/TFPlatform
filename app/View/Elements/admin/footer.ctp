	...
	<div class="clearfix top-mspace blackc container-fluid">
		<div class="row">
			<div class="span24">
				...
				<p class="span ver-space"><span class="pull-left"><a href="<?php echo Router::url('/', true); ?>" title="<?php echo __l('Powered by ') . Configure::read('site.name');?>" target="_blank" class="powered"><?php echo __l('Powered by ') . Configure::read('site.name');?></a></span> <span class="made-in pull-left">, <?php echo __l('made in'); ?></span> <?php echo $this->Html->link(__l('Nicolas Web Development'), 'http://www.Nicolas.com/', array('target' => '_blank', 'title' => __l('Nicolas Web Development'), 'class' => 'company'));?> <span class="pull-left"><?php echo Configure::read('site.version');?></span></p>
