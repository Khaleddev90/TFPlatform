...
<header id="header" class="sep-top sep-large sep-primary">
	...
	<section class="span">
	 <div class="row span22 no-mar">
      ...
      <p class="clearfix span bot-space"><span class="pull-left"><a href="http://TJPlatform.dev.Nicolas.com/" title="<?php echo __l('Powered by TJPlatform'); ?>" target="_blank" class="powered pull-left"><?php echo __l('Powered by TJPlatform');?></a>, </span><span class="pull-left hor-smspace"><?php echo Configure::read('site.version'); ?>, </span><span class="pull-left hor-smspace"><?php echo __l('made in'); ?></span><?php echo $this->Html->link(__l('Nicolas Web Development'), 'http://www.Nicolas.com/', array('target' => '_blank', 'title' => __l('Nicolas Web Development'), 'class' => 'company pull-left'));?></p>
