  ...
  <body>
    <div id="<?php echo $this->Html->getUniquePageId();?>" class="content js-responses">
      ...
      <footer id="footer" class="top-mspace space clearfix">
        <div id="Nicolas" class="clearfix container">
          ...
          <p class="powered clearfix span"><span  class="pull-left"><a href="http://TJPlatform.dev.Nicolas.com/" title="<?php echo __l('Powered by TJPlatform'); ?>" target="_blank" class="powered pull-left"><?php echo __l('Powered by TJPlatform');?></a></span><span class="made-in pull-left">,<?php echo 'made in';?></span> <a class="company pull-left" title="Nicolas Web Development" target="_blank" href="http://www.Nicolas.com/"><?php echo 'Nicolas Web Development'; ?></a> <span class="pull-left"><?php echo Configure::read('site.version');?></span></p>
