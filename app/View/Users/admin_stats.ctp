            ...
            <section class="space sep ">
              ...
              <div class="hor-mspace">
                <ul class="left-mspace grayc bot-space js-live-tour-parent">
                  <li><?php echo $this->Html->link('Product Support', 'http://customers.Nicolas.com/', array('class' => 'js-no-pjax grayc', 'target' => '_blank', 'title' => 'Product Support')); ?></li>
                  <li><?php echo $this->Html->link('Product Manual', 'http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatform-v2-0' ,array('class' => 'js-no-pjax grayc', 'target' => '_blank','title' => 'Product Manual')); ?></li>
                  ...
                  <li><?php echo $this->Html->link('Nicolas Blog', 'http://blogs.Nicolas.com/' ,array('class' => 'js-no-pjax grayc', 'target' => '_blank','title' => 'Nicolas Blog')); ?> <?php echo __l('Follow Nicolas news'); ?></li>
                </ul>
