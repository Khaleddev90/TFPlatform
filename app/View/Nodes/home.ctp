          ...
          <div class="container">
            <div class="row banner-contents trans-bg mob-no-pad">
              <div class="space dc blackc" itemscope itemtype="http://schema.org/WPHeader">
                <h2 class="textb" itemprop="headline"> <span class="show text-50"><?php echo __l('We are Nicolas'); ?></span> <span class="show text-36"><?php echo __l('Trusted for 14+ years in 173+ countries'); ?></span> </h2>
      ...
      <!-- listing block End -->
	<?php echo $this->element('Nicolas_advantages',array('cache' => array('config' => 'sec'))); ?>
