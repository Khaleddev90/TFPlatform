					...
					<?php if (!empty($setting['SettingCategory']['description']) && $setting_categories['SettingCategory']['id'] != 46):?>
						<div class="alert alert-info clearfix"><?php						
							$findReplace = array(
								...
								'##DEMO_URL##' => $this->Html->link('http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#how_to','http://dev1products.dev.Nicolas.com/doku.php?id=TJPlatformultraplus-install#how_to', array('target' => '_blank')),
							);
